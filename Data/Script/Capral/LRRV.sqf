...
_turret = "OAF_Core_LRRV_Turret" createVehicle _relpos; 
_turret attachTo [_MRAP, [0.208984,-2.5127,0.480238]]; 
...
_turret setObjectTextureGlobal [1,"a3\armor_f_tank\lt_01\data\lt_01_radar_olive_co.paa"];
